...
function ResourcePreview(props) {
  const { availableLanguages, category, cost, id, city, name, subcategory } = props;
  ...
  useEffect(() => {
    switch (subcategory) {
      ...
      case "Students":
        ...
        break;
      default:
        setSrc(category === "Citizenship" ? "/asset/subcategories/citizenship.jpg" : "https://uiuc.hack4impact.org/static/images/team-cheer.jpg")
        break;
    }
    return;
  ...
  return (
    <Link to={`resources/${id}`}>
      <Card
        cover={<div className="resource-preview-cover"><img className="resource-preview-cover-img"
          alt={subcategory}
          src={src}
        /></div>}
      >

      ...
      <>
        ...
        >
          ...
          <Col className="home-block-2__right" span={14}>
            ...
            legal resources — it can be difficult figuring out where to go in a
            large place like Champaign that has hundreds of resources and a
            population of over 80,000 people. This virtual guide, built with
            love by <a href="facebook.com/h4iuiuc"> Hack4Impact UIUC, </a>
            curates recommendations based on your cost preferences, languages
            spoken, and more — as you explore Oasis, we would love to hear about
            your experiences through the
